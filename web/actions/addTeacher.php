...
try {
    Teacher::create($form->login, $form->password, $form->firstName, $form->lastName, $form->gender, $form->room, $form->vConferenceLink, $form->vConferenceId, $form->vConferencePass);
