...
final class Appointment
{
    ...
    public static function getForTeacherAndPupil($teacherId, $pupilId)
    {
        ...
        $appointments = array();
        $sql = "SELECT r.id AS id, ts.Lehrer, ts.id AS time_slot_id, r.teacher_id AS teacher_id, r.pupil_id AS pupil_id FROM time_slots AS ts LEFT JOIN appointments AS r ON ts.id=r.time_slot_id AND (r.teacher_id=:teacher_id OR r.pupil_id=:pupil_id) WHERE ts.Lehrer='ALL' OR ts.Lehrer=:teacher_id ORDER BY ts.date ASC, ts.start_time ASC";
