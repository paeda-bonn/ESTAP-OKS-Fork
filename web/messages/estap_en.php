...
// Appointments page
    ...
    "appointments.vConferenceLink" => "Conference link",
    "appointments.vConferenceId" => "Conference Id",
    "appointments.vConferencePass" => "Conference Passcode",
...
// Teachers page
    ...
    "teachers.upload.format" => "Login;Password;First name;Last name;Gender;Room;Conference Link;Conference id;Conference pass",
...
// Edit teacher page
    ...
    "editTeacher.vConferenceLink" => "Conference Link",
    "editTeacher.vConferenceId" => "Conference id",
    "editTeacher.vConferencePass" => "Conference Passcode",
    "editTeacher.times" => "Custom time slots",
    "editTeacher.deleteTimeSlots" => "Delete all custom time slots",
    "editTeacher.timeslotsdate" => "Date",
    "editTeacher.duration" => "Duration of a time slot",
    "editTeacher.startTime" => "Starting time",
    "editTeacher.endTime" => "Ending time",
...
// Settings page
    ...
    "settings.roomsEnabled" => "Rooms enabled",
    "settings.vConferencesEnabled" => "Video conferences enabled",
